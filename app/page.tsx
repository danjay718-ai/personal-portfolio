      ...
      <div className="pt-20 pb-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-[280px]">
              ...
              <div className="space-y-3 flex-1">
                {recentProjects.map((project, i) => (
                  <a
                    key={i}
                    href="#"
                    className="block p-3 rounded-xl bg-primary/5 hover:bg-primary/10 transition-colors duration-200 group/proj"
                  >
            ...
            {/* Contact / Get in Touch - spans 2 cols */}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="relative">
                      <input
                        ...
                        required
                        className={`w-full px-4 py-2.5 bg-background border rounded-xl text-sm text-foreground placeholder-muted-foreground focus:outline-none transition-all duration-200 ${
            ...
            {/* Social Links Card */}
            <div className="bento-card bg-card border border-border rounded-2xl p-6 hover:border-primary/40 hover:shadow-md transition-all duration-300 flex flex-col justify-between group">
